...
function send_notif($email){
    $mail = new PHPMailer(true);
    try {
       // $mail->SMTPDebug = SMTP::DEBUG_SERVER;
        $mail->isSMTP();
        $mail->Host       = 'smtp-algeriadw.alwaysdata.net';
        $mail->SMTPAuth   = true;
        $mail->Username   = 'contact@algeriadw.studio';
        $mail->Password   = 'MOLImoli1';
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;

        //Recipients
        $mail->setFrom('contact@algeriadw.studio', 'AlgeriaDW Studio');
        $mail->addAddress($email);     //Add a recipient

        //Content
        //Set email format to HTML
        $mail->Subject = 'Subscribed to AlgeriaDW';
        $mail->Body    = ('
    <!DOCTYPE html
                                          ...
                                          <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                            ...
                                            <tr>
                                              <td class="two-column"
                                                ...
                                                <div class="column"
                                                  style="width:100%;max-width:80px;display:inline-block;vertical-align:top;">
                                                  <table class="contents" style="border-spacing:0; width:100%">
                                                    <tr>
                                                      <td
                                                        style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:5px;"
                                                        align="left"><a href="https://algeriadw.studio/" target="_blank"><img
                                                            src="https://algeriadw.studio/api/img/awd.png" alt=""
                                                            width="60" height="60"
                                                ...
                                                <div class="column"
                                                  style="width:100%;max-width:518px;display:inline-block;vertical-align:top;">
                                                  <table width="100%" style="border-spacing:0" cellpadding="0"
                          ...
                          <table class="contents" style="border-spacing:0; width:100%">
                            <tr>
                              <td width="39%" align="right"
                                style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><a href="https://algeriadw.studio"
                                  target="_blank"><img
                                    src="https://algeriadw.studio/api/img/awd.png"
                                  ...
                                  <tr>
                                    <td width="32%" align="center" valign="top" style="padding-top:10px">
                                      <table width="150" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="33" align="center"><a href="https://www.facebook.com/algeriadw" target="_blank"><img
                                                src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/1f9161ee-46b5-4bdf-86db-9e32d4b98336.jpg"
                                                alt="facebook" width="36" height="36" border="0"
