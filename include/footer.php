             ...
             <div class="col-md-8 col-lg-4 mb-md-4 mb-lg-0">
                 <div class="footer-single-col">
                     <div class="footer-single-col mb-4">
                         ...
                         <img src="<?= $logo_png_right_white ?>" alt="logo" class="img-fluid logo-color">
                     </div>
                     ...
                     <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                         <div class="footer-single-col">
                             ...
                             <ul class="list-unstyled footer-nav-list mb-lg-0">
                                 <li><a href="<?= $url_root ?>index-2" class="text-decoration-none">Home</a></li>
                                 <li><a href="<?= $url_root ?>about-us" class="text-decoration-none">About Us</a></li>
                                 <li><a href="<?= $url_root ?>services" class="text-decoration-none">Services</a></li>
                             </ul>
                         </div>
                     </div>
                     <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
         ...
         <div class="row justify-content-between align-items-center">
             <div class="col-md-7 col-lg-7">
                 <div class="copyright-text">
                     <p class="mb-lg-0 mb-md-0">&copy; 2022 AlgeriaDW Rights Reserved.</p>
                 </div>
             </div>
