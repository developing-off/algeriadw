            ...
            <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                ...
                <div class="row justify-content-lg-start mt-60">
                    ...
                    <div class="col-4 col-sm-3 my-2 ps-lg-0">
                        <img src="https://algeriadw.ga/assets/img/clients/client-1.svg" alt="client" class="img-fluid">
                    </div>
                    <div class="col-4 col-sm-3 my-2">
                        <img src="https://algeriadw.ga/assets/img/clients/client-2.svg" alt="client" class="img-fluid">
                    </div>
                    <div class="col-4 col-sm-3 my-2">
                        <img src="https://algeriadw.ga/assets/img/clients/client-3.svg" alt="client" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
