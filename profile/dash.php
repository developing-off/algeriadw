                    ...
                    <div class="profile-info col-md-10 col-sm-12">
                        ...
                        <div class="author-content trend-product-area shadow-less">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li>
                                    <a href="<?= $url_root ?>themes/upload-theme">
                                        <span><i class="fa-solid fa-upload"></i> Upload theme</span>
                                    </a>
                                </li>
                            </ul>
                            <!-- End Tab Nav -->
                            ...
                            <div class="tab-content tab-content-info">
                                            ...
                                            <div class="col-md-4 col-sm-6 single-item">
                                                <div class="item">
                                                    <div class="thumb">
                                                        ...
                                                        <a href="<?= $url_root ?>themes/edit-post/<?= $themeauthor['id'] ?>"><img src="<?= $themeauthor['image_path'] ?>"
                                                                alt="Thumb"></a>
                                                    </div>
                                                    <div class="info-box">
                                                        <div class="top-info">
                                                            <h4>
                                                                <a href="<?= $url_root ?>themes/edit-post/<?= $themeauthor['id'] ?>"><?= $themeauthor['title'] ?></a>
                                                            </h4>
                                                            <div class="author">

                                                                <span><a href="<?= $url_root ?>themes/search/<?= $themeauthor['tags'] ?>"><?= $themeauthor['tags'] ?></a> / <a
                                                                        href="<?= $url_root ?>themes/search/<?= $themeauthor['technology'] ?>"><?= $themeauthor['technology'] ?></a></span>
                                                            </div>
                                                            <div class="item-type">
                                                                <p><i class="fas fa-shopping-cart"></i>
                                                                    <?= $themeauthor['download_number'] ?> Sales</p>
                                                                <div class="rating">
                                                        ...
                                                        <div class="bottom-info">
                                                            <div class="item-preview">
                                                                <a href="<?= $url_root ?>themes/edit-post/<?= $themeauthor['id'] ?>">Edit Preview</a>
                                                            </div>
                                                            <div class="price">
                                ...
                                <div id="tab2" class="tab-pane fade">
                                    <div class="followers row">
                                        <div class="item">
                                            <a href="#">
                                                <img src="https://algeriadw.studio/assets/themes/img/top-cat/1.jpg"
                                                    alt="Thumb">
                                            </a>
                                        </div>
