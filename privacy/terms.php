                ...
                <div class="row justify-content-between">
                    <div class="col-lg-4 col-md-4 d-none d-md-block d-lg-block">
                        <div class="support-article-sidebar sticky-sidebar">
                            ...
                            <div class="bg-light p-5 mt-4 rounded-custom quick-support">
                                ...
                                <a href="mailto:support@algeriadw.studio"
                                    class="text-decoration-none text-muted d-flex align-items-center py-2">
                                    <div class="quick-support-icon rounded-circle bg-primary-soft me-3">
                                        <i class="far fa-envelope text-primary"></i>
                                    </div>
                                    <div class="contact-option-text">support@algeriadw.studio</div>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 p-lg-5">
                        <div class="support-article-wrap">
                            <h1 class="display-5 mb-4 fw-bold">Website Terms and Conditions of Use</h1>
                            ...
                            <div class="job-details-info my-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p><strong>Website</strong> refers to AlgeriaDW, accessible from <a
                                                href="https://algeriadw.studio/" rel="external nofollow noopener"
                                                target="_blank">https://algeriadw.studio/</a></p>
                                    </li>
                                    <li>
                                ...
                                <ul>
                                    <li>
                                        <p>By email: support@algeriadw.studio</p>
                                    </li>
                                    <li>
                                        <p>By visiting this page on our website: <a
                                                href="https://algeriadw.studio/contact-us"
                                                rel="external nofollow noopener"
                                                target="_blank">https://algeriadw.studio/contact-us</a></p>
                                    </li>
                                    <li>
                                        <p>By phone number: +213560480184</p>
                                    </li>
                                </ul>
